  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
        <img 
  src="./img/LogoWithBckgdcropped.png" 
  alt="Logoipsum" 
  style={{ width: "240px", height: "auto" }} />
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/richiechuck.acquah/"
            ...
            <li>
              <a
                href="https://www.instagram.com/iamthe_richie"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/racquah"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
